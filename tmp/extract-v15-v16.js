...
try {
  ...
  try {
    ...
    try {
      ...
      console.log('Using UTF-8 (likely garbled)');
    }
  }
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // Match patterns like "第15卷" or "第十五卷"
  ...
  for (const targetVol of [15, 16]) {
    ...
    console.log(`First line: ${volLines[0]?.trim().substring(0, 100)}`);
