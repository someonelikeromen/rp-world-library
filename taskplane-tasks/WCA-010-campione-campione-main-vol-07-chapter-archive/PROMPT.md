# Task: WCA-010 - campione campione-main vol-07 chapter archive
...
```
taskplane-tasks/WCA-010-campione-campione-main-vol-07-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-07` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 弑神者！ / campione-main / vol-07. Detected source files: 9.
...
- `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-07`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-07`
...
- [ ] Verify source dir exists: campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-07
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-07/*.json`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-07/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-07.validation.json`
- `campaigns/world-library/worlds/campione/curated/stories/retry-queues/campione-main/vol-07.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-07.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-07.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-07.lessons.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-07.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-07.md`
...
If committing, every commit message must include `WCA-010`.
