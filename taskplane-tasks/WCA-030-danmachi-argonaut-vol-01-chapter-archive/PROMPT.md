# Task: WCA-030 - danmachi argonaut vol-01 chapter archive
...
```
taskplane-tasks/WCA-030-danmachi-argonaut-vol-01-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/danmachi/sources/raw-text/argonaut/vol-01` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 在地下城寻求邂逅是否搞错了什么 / argonaut / vol-01. Detected source files: 13.
...
- `campaigns/world-library/worlds/danmachi/sources/raw-text/argonaut/vol-01`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/argonaut/vol-01`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/argonaut`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/argonaut`
- `campaigns/world-library/worlds/danmachi/curated/stories/retry-queues/argonaut`

## Steps

### Step 0: Preflight

- [ ] Verify source dir exists: campaigns/world-library/worlds/danmachi/sources/raw-text/argonaut/vol-01
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/argonaut/vol-01/*.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/argonaut/vol-01/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/argonaut/vol-01.validation.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/retry-queues/argonaut/vol-01.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/argonaut/vol-01.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/argonaut/vol-01.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/argonaut/vol-01.lessons.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/argonaut/vol-01.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/argonaut/vol-01.md`
...
If committing, every commit message must include `WCA-030`.
