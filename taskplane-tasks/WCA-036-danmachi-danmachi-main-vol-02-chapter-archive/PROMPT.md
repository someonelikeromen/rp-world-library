# Task: WCA-036 - danmachi danmachi-main vol-02 chapter archive
...
```
taskplane-tasks/WCA-036-danmachi-danmachi-main-vol-02-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-02` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 在地下城寻求邂逅是否搞错了什么 / danmachi-main / vol-02. Detected source files: 10.
...
- `campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-02`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-02`
...
- [ ] Verify source dir exists: campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-02
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-02/*.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-02/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-02.validation.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/retry-queues/danmachi-main/vol-02.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-02.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-02.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-02.lessons.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/danmachi-main/vol-02.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/danmachi-main/vol-02.md`
...
If committing, every commit message must include `WCA-036`.
