# Task: WCA-046 - danmachi danmachi-main vol-12 chapter archive
...
```
taskplane-tasks/WCA-046-danmachi-danmachi-main-vol-12-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-12` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 在地下城寻求邂逅是否搞错了什么 / danmachi-main / vol-12. Detected source files: 13.
...
- `campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-12`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-12`
...
- [ ] Verify source dir exists: campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-12
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-12/*.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-12/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-12.validation.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/retry-queues/danmachi-main/vol-12.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-12.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-12.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-12.lessons.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/danmachi-main/vol-12.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/danmachi-main/vol-12.md`
...
If committing, every commit message must include `WCA-046`.
