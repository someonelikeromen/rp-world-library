# Task: WCA-001 - campione campione-main vol-01 chapter archive
...
```
taskplane-tasks/WCA-001-campione-campione-main-vol-01-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-01` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 弑神者！ / campione-main / vol-01. Detected source files: 10.
...
- `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-01`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-01`
...
- [ ] Verify source dir exists: campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-01
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-01/*.json`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-01/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-01.validation.json`
- `campaigns/world-library/worlds/campione/curated/stories/retry-queues/campione-main/vol-01.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-01.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-01.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-01.lessons.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-01.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-01.md`
...
If committing, every commit message must include `WCA-001`.
