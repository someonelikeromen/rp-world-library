# Task: WCA-032 - danmachi astraea-record vol-01 chapter archive
...
```
taskplane-tasks/WCA-032-danmachi-astraea-record-vol-01-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/danmachi/sources/raw-text/astraea-record/vol-01` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 在地下城寻求邂逅是否搞错了什么 / astraea-record / vol-01. Detected source files: 18.
...
- `campaigns/world-library/worlds/danmachi/sources/raw-text/astraea-record/vol-01`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/astraea-record/vol-01`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/astraea-record`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/astraea-record`
- `campaigns/world-library/worlds/danmachi/curated/stories/retry-queues/astraea-record`

## Steps

### Step 0: Preflight

- [ ] Verify source dir exists: campaigns/world-library/worlds/danmachi/sources/raw-text/astraea-record/vol-01
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/astraea-record/vol-01/*.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/astraea-record/vol-01/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/astraea-record/vol-01.validation.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/retry-queues/astraea-record/vol-01.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/astraea-record/vol-01.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/astraea-record/vol-01.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/astraea-record/vol-01.lessons.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/astraea-record/vol-01.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/astraea-record/vol-01.md`
...
If committing, every commit message must include `WCA-032`.
