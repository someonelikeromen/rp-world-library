# Task: WCA-019 - campione campione-main vol-16 chapter archive
...
```
taskplane-tasks/WCA-019-campione-campione-main-vol-16-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-16` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 弑神者！ / campione-main / vol-16. Detected source files: 8.
...
- `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-16`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-16`
...
- [ ] Verify source dir exists: campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-16
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-16/*.json`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-16/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-16.validation.json`
- `campaigns/world-library/worlds/campione/curated/stories/retry-queues/campione-main/vol-16.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-16.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-16.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-16.lessons.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-16.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-16.md`
...
If committing, every commit message must include `WCA-019`.
