# Task: WCA-146 - type-moon-nasuverse fgo curated story archive
...
```
taskplane-tasks/WCA-146-type-moon-nasuverse-fgo-curated-story-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every Markdown story source in `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/fgo` fully. After each file, immediately write curated-derived archive JSON/MD. Then validate and refine 型月 / Nasuverse / fgo. Detected source files: 30.
...
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/fgo`
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/chapter-archives-curated/fgo`
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/curated-unit-archives`
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/retry-queues-curated/fgo`

## Steps

### Step 0: Preflight

- [ ] Verify source dir exists: campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/fgo
...
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/chapter-archives-curated/fgo/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/curated-unit-archives/fgo.validation.json`
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/retry-queues-curated/fgo/fgo.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/curated-unit-archives/fgo.json`
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/curated-unit-archives/fgo.md`
- `campaigns/world-library/worlds/type-moon-nasuverse/curated/stories/curated-unit-archives/fgo.lessons.md`
...
If committing, every commit message must include `WCA-146`.
