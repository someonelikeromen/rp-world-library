# Task: WCA-138 - infinite-stratos vol-4 curated story archive
...
```
taskplane-tasks/WCA-138-infinite-stratos-vol-4-curated-story-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every Markdown story source in `campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-4` fully. After each file, immediately write curated-derived archive JSON/MD. Then validate and refine IS〈Infinite Stratos〉 / vol-4. Detected source files: 5.
...
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-4`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-4`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/retry-queues-curated/vol-4`

## Steps

### Step 0: Preflight

- [ ] Verify source dir exists: campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-4
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-4/*.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-4/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-4.validation.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/retry-queues-curated/vol-4/vol-4.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-4.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-4.md`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-4.lessons.md`
...
If committing, every commit message must include `WCA-138`.
