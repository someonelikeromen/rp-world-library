# Task: WCA-143 - infinite-stratos vol-9 curated story archive
...
```
taskplane-tasks/WCA-143-infinite-stratos-vol-9-curated-story-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every Markdown story source in `campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-9` fully. After each file, immediately write curated-derived archive JSON/MD. Then validate and refine IS〈Infinite Stratos〉 / vol-9. Detected source files: 5.
...
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-9`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-9`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/retry-queues-curated/vol-9`

## Steps

### Step 0: Preflight

- [ ] Verify source dir exists: campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-9
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-9/*.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-9/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-9.validation.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/retry-queues-curated/vol-9/vol-9.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-9.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-9.md`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-9.lessons.md`
...
If committing, every commit message must include `WCA-143`.
