# Task: WCA-140 - infinite-stratos vol-6 curated story archive
...
```
taskplane-tasks/WCA-140-infinite-stratos-vol-6-curated-story-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every Markdown story source in `campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-6` fully. After each file, immediately write curated-derived archive JSON/MD. Then validate and refine IS〈Infinite Stratos〉 / vol-6. Detected source files: 5.
...
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-6`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-6`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/retry-queues-curated/vol-6`

## Steps

### Step 0: Preflight

- [ ] Verify source dir exists: campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-6
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-6/*.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-6/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-6.validation.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/retry-queues-curated/vol-6/vol-6.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-6.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-6.md`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-6.lessons.md`
...
If committing, every commit message must include `WCA-140`.
