# Task: WCA-023 - campione campione-main vol-20 chapter archive
...
```
taskplane-tasks/WCA-023-campione-campione-main-vol-20-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-20` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 弑神者！ / campione-main / vol-20. Detected source files: 9.
...
- `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-20`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-20`
...
- [ ] Verify source dir exists: campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-20
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-20/*.json`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-20/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-20.validation.json`
- `campaigns/world-library/worlds/campione/curated/stories/retry-queues/campione-main/vol-20.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-20.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-20.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-20.lessons.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-20.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-20.md`
...
If committing, every commit message must include `WCA-023`.
