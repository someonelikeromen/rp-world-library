# Task: WCA-013 - campione campione-main vol-10 chapter archive
...
```
taskplane-tasks/WCA-013-campione-campione-main-vol-10-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-10` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 弑神者！ / campione-main / vol-10. Detected source files: 10.
...
- `campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-10`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-10`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main`
- `campaigns/world-library/worlds/campione/curated/stories/retry-queues/campione-main`

## Steps

### Step 0: Preflight

- [ ] Verify source dir exists: campaigns/world-library/worlds/campione/sources/raw-text/campione-main/vol-10
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-10/*.json`
- `campaigns/world-library/worlds/campione/curated/stories/chapter-archives/campione-main/vol-10/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-10.validation.json`
- `campaigns/world-library/worlds/campione/curated/stories/retry-queues/campione-main/vol-10.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-10.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-10.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-archives/campione-main/vol-10.lessons.md`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-10.json`
- `campaigns/world-library/worlds/campione/curated/stories/volume-refined/campione-main/vol-10.md`
...
If committing, every commit message must include `WCA-013`.
