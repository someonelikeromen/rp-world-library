# Task: WCA-139 - infinite-stratos vol-5 curated story archive
...
```
taskplane-tasks/WCA-139-infinite-stratos-vol-5-curated-story-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every Markdown story source in `campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-5` fully. After each file, immediately write curated-derived archive JSON/MD. Then validate and refine IS〈Infinite Stratos〉 / vol-5. Detected source files: 5.
...
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-5`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-5`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/retry-queues-curated/vol-5`

## Steps

### Step 0: Preflight

- [ ] Verify source dir exists: campaigns/world-library/worlds/infinite-stratos/curated/stories/vol-5
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-5/*.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/chapter-archives-curated/vol-5/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-5.validation.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/retry-queues-curated/vol-5/vol-5.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-5.json`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-5.md`
- `campaigns/world-library/worlds/infinite-stratos/curated/stories/curated-unit-archives/vol-5.lessons.md`
...
If committing, every commit message must include `WCA-139`.
