# Task: WCA-038 - danmachi danmachi-main vol-04 chapter archive
...
```
taskplane-tasks/WCA-038-danmachi-danmachi-main-vol-04-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-04` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 在地下城寻求邂逅是否搞错了什么 / danmachi-main / vol-04. Detected source files: 13.
...
- `campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-04`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-04`
...
- [ ] Verify source dir exists: campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-04
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-04/*.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-04/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-04.validation.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/retry-queues/danmachi-main/vol-04.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-04.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-04.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-04.lessons.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/danmachi-main/vol-04.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/danmachi-main/vol-04.md`
...
If committing, every commit message must include `WCA-038`.
