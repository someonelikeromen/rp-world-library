# Task: WCA-060 - danmachi danmachi-main vol-26 chapter archive
...
```
taskplane-tasks/WCA-060-danmachi-danmachi-main-vol-26-chapter-archive/
├── PROMPT.md
├── STATUS.md
├── .reviews/
└── .DONE
...
Read every .txt chapter in `campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-26` fully and in filename order. After each chapter, immediately write chapter archive JSON/MD. Then validate and refine 在地下城寻求邂逅是否搞错了什么 / danmachi-main / vol-26. Detected source files: 2.
...
- `campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-26`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-26`
...
- [ ] Verify source dir exists: campaigns/world-library/worlds/danmachi/sources/raw-text/danmachi-main/vol-26
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-26/*.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/chapter-archives/danmachi-main/vol-26/*.md`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-26.validation.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/retry-queues/danmachi-main/vol-26.retry.json`
...
**Artifacts:**
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-26.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-26.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-archives/danmachi-main/vol-26.lessons.md`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/danmachi-main/vol-26.json`
- `campaigns/world-library/worlds/danmachi/curated/stories/volume-refined/danmachi-main/vol-26.md`
...
If committing, every commit message must include `WCA-060`.
