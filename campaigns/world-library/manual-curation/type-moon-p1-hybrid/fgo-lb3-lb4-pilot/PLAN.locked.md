# Locked Plan: FGO Lostbelt 3-4 P1 Prep Gate

Date: 2026-07-12
Step id: `prep-lb3-lb4`
Pilot root: `campaigns/world-library/manual-curation/type-moon-p1-hybrid/fgo-lb3-lb4-pilot/`
Required model for later execution agents: `lt-yuyu/gpt-5.5`

## Objective

Prepare only the Lostbelt 3-4 prep gate scaffold, source inventory, source classification report, source-unit manifest, execution log, status, and two chapter-extraction work packets for entries 95-96 of `[沙盒]FGO 0.8.worldbook.json`.
...
|---:|---|---|---|---:|---:|---|
| 95 | `fgo-lb3-renzhi-tonghe-zhenguo` | `lb3-renzhi-tonghe-zhenguo` | `FGO_LB3_人智统合真国` | 21 | 34 | `[沙盒]FGO 0.8.worldbook.json:12320-12321` |
| 96 | `fgo-lb4-chuangshi-miewang-lunhui` | `lb4-chuangshi-miewang-lunhui` | `FGO_LB4_创世灭亡轮回` | 21 | 25 | `[沙盒]FGO 0.8.worldbook.json:12443-12444` |
...
This prep stage is complete only after the seven named scaffold artifacts and exactly two `work-packets/lostbelt/*.json` files for LB3 and LB4 are written under the pilot root. No extraction, normalization, merge, source text, graph, timeline, source import change, or old curated change is authorized.
